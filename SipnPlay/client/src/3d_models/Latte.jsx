...
import LatteScene from '../assets/cafe_latte_with_art.glb';

const Latte = ({ isRotating,
    setIsRotating,
    setCurrentStage,
    currentFocusPoint,
    ...props }) => {
    ...
    const { nodes, materials } = useGLTF(LatteScene);
    ...
    return (
        <a.group ref={islandRef} {...props} >
            <group scale={0.05}>
                <group rotation={[-Math.PI / 2, 0, 0]} scale={45.313}>
                    <mesh
                        castShadow
                        receiveShadow
