...
function CalEvent() {
  ...
  const handleSelectDate = ({ start }) => {
    ...
    const eventsOnDate = events.filter((event) => moment(event.start).isSame(start, "day"))
                  ...
                  <form className="needs-validation" onSubmit noValidate>
                    <div className="modal-content">
                      ...
                      <div className="modal-header">
                        <h5 className="modal-title" id="createEventlabel">
                          User Registration
                        </h5>
            ...
            <div>
              <div>
                <form>
                  ...
                  <br />
                  <input type="datetime-local" id="start" name="meeting-time" value="2018-06-12T19:30" />
                  <br></br>
                  <label for="end">End</label>
                  <br />
                  <input type="datetime-local" id="end" name="meeting-time" value="2018-06-12T19:30" />
                </form>
              </div>
              ...
              <label for="reccId" className="form-label">
                Recurrence
              </label>
              <select className="form-select" id="reccId" aria-label="Default select example">
